...
#### Therefore, we have weak correlation between Price and taxable_income_amt, inctax_amt, and agi_amt. No correlation among other variables.
...
```{r}
par(mfrow=c(2,3))
boxplot(subData$p_unemploy_nr,main="p_unemploy_nr")
